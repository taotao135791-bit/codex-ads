---
name: ads
description: "Route paid advertising work to Codex Ads sub-skills for audits, reports, ops, planning, creative, tracking, PPC math, and KPI diagnosis."
...
Use templates from `skills/ads-ops/assets/`. Ask before storing real client
identifiers; anonymize by default.
