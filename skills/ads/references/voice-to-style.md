...
specific aesthetic attributes that become the [STYLE] component in provider prompts.
...
5. Append the [STYLE] string to the provider prompt template before generation.
